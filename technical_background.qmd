...
This document was created are using the **quarto** package [@R-quarto] to format this book.  Each page can be updated by editing the .qmd file and pressing "render".  Use Build > Render Book to make whole website again.
