...
postworkshopsurveys_named <- FeedbackActuallyAttended2 %>%
...
postworkshopsurveys_named$How.did.you.hear.about.this.workshop.[postworkshopsurveys_named$How.did.you.hear.about.this.workshop.=="Email from OU Libraries"] <- "Direct Email from OU Libraries (Source Unknown)"
postworkshopsurveys_named$How.did.you.hear.about.this.workshop.[postworkshopsurveys_named$How.did.you.hear.about.this.workshop.=="Colleagues"] <- "Colleagues (Forwarded email, word of mouth)"
postworkshopsurveys_named$How.did.you.hear.about.this.workshop.[postworkshopsurveys_named$How.did.you.hear.about.this.workshop.=="Supervisor"] <- "Supervisor (Forwarded email, word of mouth)"
postworkshopsurveys_named$How.did.you.hear.about.this.workshop.[postworkshopsurveys_named$How.did.you.hear.about.this.workshop.=="Flyer"] <- "Flyer (Paper or Digital Unspecified)"

postworkshopsurveys_named$ReducedCategories <- postworkshopsurveys_named$How.did.you.hear.about.this.workshop.
postworkshopsurveys_named$ReducedCategories[!(postworkshopsurveys_named$How.did.you.hear.about.this.workshop. %in% marketing_current_categories)] <- "Other (please describe)"
postworkshopsurveys_named$OtherDescriptions[!(postworkshopsurveys_named$How.did.you.hear.about.this.workshop. %in% marketing_current_categories)] <- postworkshopsurveys_named$How.did.you.hear.about.this.workshop.[!(postworkshopsurveys_named$How.did.you.hear.about.this.workshop. %in% marketing_current_categories)]
```
...
```{r, data_cleanup_topics, include = FALSE}
...
postworkshopsurveys_named <- left_join(postworkshopsurveys,
                                       topics_complete_variations_cleaned,
...
attendance_named$hour <-
  format(attendance_named$Event.Date.and.Time_2, "%H")

attendance_named$Date <-
  format(attendance_named$Event.Date.and.Time_2, "%m/%d/%Y")
...
postworkshopsurveys_named$Date <-
  format(postworkshopsurveys_named$Date_2, "%m/%d/%Y")
...
joined_post <- left_join(postworkshopsurveys_named, 
                         attendance_named,
