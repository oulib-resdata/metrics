...
FeedbackActuallyAttended <- FeedbackActuallyAttended %>%
...
# Claire finish this and tidy it up, pivot wider/longer as needed
# remove extra ... s
...
# Month, day, year, hour, minute, seconds
FeedbackActuallyAttended$Date_2 <- mdy_hms(FeedbackActuallyAttended$What.date.was.the.workshop.,
                                                           truncated = 3)


# separate year, month, date, times
FeedbackActuallyAttended$year <- year(FeedbackActuallyAttended$Date_2)
FeedbackActuallyAttended$month <- month(FeedbackActuallyAttended$Date_2)
FeedbackActuallyAttended$day <- day(FeedbackActuallyAttended$Date_2)
FeedbackActuallyAttended$wday <- wday(FeedbackActuallyAttended$Date_2,
                                      week_start = 1, #1 = Monday,
                                      label = TRUE    # days of weeks as characters
                                      )

# Overwrite original column with formatted date
FeedbackActuallyAttended$Date <-
  format(FeedbackActuallyAttended$Date_2, "%m/%d/%Y")
...
joined_post <- left_join(FeedbackActuallyAttended, 
