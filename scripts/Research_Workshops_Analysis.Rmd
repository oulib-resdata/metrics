...
# Filtering by NA is necessary because not everyone has entered their workshops into LibInsights, resulting in no attendance or format data to associate with the feedback.
