...
There was no difference in workshop satisification relating to perception of the material as "valuable to my program of study" between workshop formats.
...
```{r, workshop_feedback_valuableforprogram_plot, eval = workshop_feedback_valuableforprogram_plot}
#will only eval (ie plot) if test in previous chunk is significant
