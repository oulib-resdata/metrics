...
## This is outreach + courses combined.
...
post_test2 <- post_test %>% separate_longer_delim(This.workshop.was...,
                                                  delim = ", ...")
post_test3 <- post_test2 %>% separate_wider_delim(cols = This.workshop.was...,
                                                  delim = ". - ",
